                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}"  class="needs-validation" novalidate>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="nombres" type="text" class="form-control{{ $errors->has('nombres') ? ' is-invalid' : '' }}" name="nombres" value="{{ old('name') }}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="correo_envio" type="email" class="form-control{{ $errors->has('correo_envio') ? ' is-invalid' : '' }}" name="correo_envio" value="{{ old('correo_envio') }}" required>

                                @if ($errors->has('correo_envio'))
                                    <span class="invalid-feedback" role="alert">
                        ...
                        <div class="form-group">
                          <label for="rol">Tipo se usuario</label>
